 ...
 *
 */
final class LocalStatisticsProcessor2 implements Processor {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3967695130634517631L;
	private static Logger logger = LoggerFactory.getLogger(LocalStatisticsProcessor2.class);
    ...
    private LocalStatisticsProcessor2(Builder builder){
	...
	public Processor newProcessor(Processor p) {
		LocalStatisticsProcessor2 oldProcessor = (LocalStatisticsProcessor2) p;
		LocalStatisticsProcessor2 newProcessor 
			= new LocalStatisticsProcessor2.Builder(oldProcessor).build();
    ...
    static class Builder{
    	...
    	Builder(LocalStatisticsProcessor2 oldProcessor){
    	...
    	LocalStatisticsProcessor2 build(){
    		return new LocalStatisticsProcessor2(this);
    	}    	
    }
