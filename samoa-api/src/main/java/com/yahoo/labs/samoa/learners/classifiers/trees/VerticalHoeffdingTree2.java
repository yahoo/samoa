 ...
 *
 */
public final class VerticalHoeffdingTree2 implements Learner, Configurable {
    ...
    private ModelAggregatorProcessor2 modelAggrProc;
    ...
    private LocalStatisticsProcessor2 locStatProc;
    ...
    public void init(TopologyBuilder topologyBuilder, Instances dataset, int parallelism) {
        ...
        this.modelAggrProc = new ModelAggregatorProcessor2.Builder(dataset)
        ...
        this.computeStream.setBatchSize(1);
